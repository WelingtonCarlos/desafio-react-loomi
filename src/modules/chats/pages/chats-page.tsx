...
export function ChatPage() {
  const { data: chatsData, isLoading, isError, refetch } = useChatsData();
      ...
      <div className="mx-auto flex flex-col">
        ...
        <div className="p-6">
          <ErrorState
            ...
            onRetry={refetch}
            className="bg-gradient-glass border-soft h-[300px] border"
          />
        </div>
      </div>
    );
  ...
  return (
    <div className="mx-auto flex flex-col">
      ...
      <div className="flex h-[calc(100vh-102px)] flex-col-reverse lg:flex-row">
        <div className="flex flex-1 flex-col overflow-hidden border border-white/5 bg-[#050816]">
        ...
        <div className="w-full shrink-0 lg:w-[360px]">
          <div className="h-full overflow-hidden border border-white/5">
